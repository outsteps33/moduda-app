...
export const Services = () => {
  ...
  return (
      ...
      <ServiceContainer>
        ...
        <Service className="cursor-pointer hover:text-gray-500" onClick={() => window.open('https://docs.google.com/forms/d/e/1FAIpQLSeqzx2OScAqfSjXmSAJQ0UotKNs69NvTts-2szxpvOfeVBPAw/viewform')}>
