...
const ToastReviewUpdateEditor:FC<Props> = ({ id, previousTitle, previousthumb, contents }) => {
  const editorRef = createRef<Editor>();
  const router = useRouter();
  const [ReviewUpload, { loading, data, error }] = useMutation("/api/editReview");
...
export default ToastReviewUpdateEditor;