...
const BackgroundItem = require('../images/BackgroundItem.png');
const SemiBackground = require('../images/semi_background.png');
const Feature1 = require('../images/fature1.png');
const Feature2 = require('../images/fature2.png');
const Feature3 = require('../images/fature3.png');
const Apply = require('../images/applyImage.png');
const Apply1 = require('../images/apply1.png');
const Apply2 = require('../images/apply2.png');
const Apply3 = require('../images/apply3.png');
const Apply4 = require('../images/apply4.png');
